      ...
      elements: {
        ...
        fields: {
          name: {
            ...
            rule: yup.string().required(i18next.t('required')).matches(/^[аАбБвВгГдДеЕёЁжЖзЗиИйЙкКлЛмМнНоОпПрРсСтТуУфФхХцЦчЧшШщЩъЪыЫьЬэЭюЮяЯaA-zZ\s]+$/, i18next.t('onlyletters')).trim(),
